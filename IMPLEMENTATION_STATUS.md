...
| Web 后台 | 唯一管理员首次创建、管理员密码 + Microsoft TOTP、极简概览/App 账号/AI 服务/安全审计/设置页、管理员改密与 TOTP 重绑二次验证、全会话撤销、短时重绑密文、Provider AES-GCM 与只写 Key、Provider 公网 HTTPS/防重定向约束、设备 Token 哈希/撤销、D1/R2、限流 AI 测试、生图、敏感元数据过滤审计、投票管理 |
...
- Web：ESLint、TypeScript、vinext 生产构建和 15 项安全/黑盒 SSR/health 测试通过。
